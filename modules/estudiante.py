...
def panel_estudiante():
    ...
    r1 = st.text_area(caso[5], height=120)
    r2 = st.text_area(caso[6], height=120)
    r3 = st.text_area(caso[7], height=120)
    r4 = st.text_area(caso[8], height=120)

    if st.button("Enviar respuestas"):
        if estudiante and r1 and r2 and r3 and r4:
            guardar_respuesta(caso[0], estudiante, r1, r2, r3, r4)
